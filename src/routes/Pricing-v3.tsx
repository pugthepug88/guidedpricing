    ...
    <Reveal delay={index * 0.04} className="h-full">
      ...
      >
        ...
        <div className="mt-4 flex min-h-[52px] items-end gap-2">
          <strong className={`${custom ? "text-[40px]" : "text-[48px] sm:text-[50px]"} font-medium leading-none tracking-[-0.06em]`} style={{ fontFamily: DISPLAY }}>{plan.price}</strong>
          <span className="pb-1 text-[11px] font-semibold text-[#77716A]">{plan.priceLabel}</span>
        </div>
