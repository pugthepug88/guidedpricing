...
const LAUNCH_SCOPES = [
  ...
  },
  {
    ...
    sub: "For businesses with multiple locations, larger data moves or setup outside the standard plans.",
    items: [
      "Multiple locations or brands",
      "Larger or more complex data imports",
      "Connections to other software",
      "Custom workflows or reporting",
      "Setup and support agreed before work starts",
    ],
  },
] as const;
