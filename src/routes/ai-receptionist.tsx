          ...
          >
            ...
            <div className="mt-3 space-y-2.5">
              <div className="max-w-[82%]">
                <div className="mb-1 text-[8px] font-semibold uppercase tracking-[0.14em] text-[#817A72]">Caller</div>
                <div className="rounded-[14px] rounded-tl-[5px] border border-white/55 bg-white/55 px-3 py-2 text-[11px] font-medium leading-[1.42] text-[#343834] shadow-[0_4px_14px_rgba(22,25,24,.05)]">
