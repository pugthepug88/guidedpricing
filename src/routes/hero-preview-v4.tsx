...
function AgentBoardScene() {
  ...
  return (
    <div ref={hostRef} className="relative w-full">
      ...
      <div className="mt-6 flex flex-nowrap items-center justify-center gap-x-3 overflow-x-auto px-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:gap-x-4">
        {SCENES.map((s, i) => {
          const on = i === index;
          return (
            <button
              ...
              className="group flex shrink-0 items-center gap-2 whitespace-nowrap text-[15px] transition lg:text-base"
            >
              <span
