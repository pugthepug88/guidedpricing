...
- [ ] Revise `/Pricing-v3` to the approved two-plan buying architecture with a subordinate Custom path.
- [ ] Complete four-director sign-off, build checks, responsive QA, and unchanged-route smoke checks.
